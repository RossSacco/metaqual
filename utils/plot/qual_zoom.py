...
def plot_roc_detail(
    ...
    ax.set_title("ROC Detail for Passage Quality Estimators")
...
def main():
    ...
    parser.add_argument(
        "--output_path",
        default="metaqual/utils/plot/roc_detail_modular.png",
    )

    parser.add_argument("--x_min", type=float, default=0.80)
    parser.add_argument("--x_max", type=float, default=1.00)
    parser.add_argument("--y_min", type=float, default=0.935)
